...
# $settings['install_profile'] = '';
	 ...
	 * @endcode
	 */
	$settings['hash_salt'] = 'eriqCm7AUKj5FwLG6_PIRXEQMl5IMpXxwAsvqDsmWegEjC6GmfZXzbcmt_QKaSPEN7LUpsfIGA';
...
# $settings['file_public_base_url'] = 'http://downloads.example.com/files';
	 ...
	 */
	$settings['file_public_path'] = 'sites/www.ianmoffitt.co/files';
	 ...
	 */
	$settings['file_private_path'] = 'sites/www.ianmoffitt.co/files/private';
...
#
	...
	} else if (file_exists($app_root . '/' . $site_path . '/settings.remote.php')) {
		include $app_root . '/' . $site_path . '/settings.remote.php';
	}

	$settings['install_profile'] = 'minimal';
	$config_directories['sync'] = 'sites/default/files/config_U-QzKggTd459dUX_VGhu-vDC6FHJFrOsiTl-pMjTPn6n2VO7PuReXPcMuc7Wxhsm_VlwrT5JEQ/sync';
	$databases['default']['default'] = array(
		'database'  => 'drupal',
		'username'  => 'drupal',
		'password'  => 'jRxbs21hJo8mOrRY',
		'prefix'    => '',
		'host'      => '127.0.0.1',
		'port'      => '3306',
