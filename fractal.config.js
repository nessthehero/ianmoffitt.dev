...
const config = require('./src/config/_ian.json');
 ...
 * Handlebars Helpers
 */
const ianHelpers = require('./src/lib/helpers/helpers');
const handlebarsHelpers = require('handlebars-helpers')();

let helpers = Object.assign({}, handlebarsHelpers, ianHelpers);
